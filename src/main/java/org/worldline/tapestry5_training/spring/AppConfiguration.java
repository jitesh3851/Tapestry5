package org.worldline.tapestry5_training.spring;
...
@Configuration
@ComponentScan({ "org.worldline.tapestry5_training" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.worldline.tapestry5_training");
                servletContext.setInitParameter("tapestry.development-modules", "org.worldline.tapestry5_training.services.DevelopmentModule");
